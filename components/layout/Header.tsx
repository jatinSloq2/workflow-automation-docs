    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/80 dark:bg-black/80 light:bg-white/80 backdrop-blur-xl border-b border-white/10 dark:border-white/10 light:border-gray-200 transition-colors duration-200">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white text-center py-2 px-4 text-sm">
        <div className="flex items-center justify-center gap-2">
          ...
          <span>New: AI Vision nodes now available - </span>
          <Link href="/blog/ai-vision" className="underline font-semibold hover:text-purple-200">
            Learn more →
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="h-10 w-10 bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl flex items-center justify-center transform group-hover:scale-110 transition-transform">
                ...
                >
                  <div className="p-2">
                    <Link href="/features" className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
                      ...
                      <div>
                        <div className="font-semibold text-white group-hover:text-purple-400 transition-colors">Features</div>
                        <div className="text-xs text-gray-400">Explore all capabilities</div>
                      </div>
                    </Link>
                    <Link href="/pricing" className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
                      <Sparkles className="h-5 w-5 text-blue-400 mt-0.5" />
                      <div>
                        <div className="font-semibold text-white group-hover:text-blue-400 transition-colors">Pricing</div>
                        <div className="text-xs text-gray-400">Simple, transparent pricing</div>
                      </div>
                    </Link>
                    <Link href="/integrations" className="flex items-start gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors group">
                      <Code className="h-5 w-5 text-pink-400 mt-0.5" />
                      <div>
                        <div className="font-semibold text-white group-hover:text-pink-400 transition-colors">Integrations</div>
                        <div className="text-xs text-gray-400">Connect to 100+ services</div>
                      </div>
                    </Link>
                  </div>
                </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/signup"
              className="relative group px-5 py-2 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-semibold text-sm transition-all hover:scale-105 hover:shadow-lg hover:shadow-purple-500/50"
            >
        ...
        <div className="lg:hidden border-t border-white/10 bg-black/95 backdrop-blur-xl">
          <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
            <div className="space-y-2">
              ...
              <Link href="/integrations" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                Integrations
              </Link>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Link href="/docs" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                Documentation
              </Link>
              <Link href="/blog" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                Blog
              </Link>
              <Link href="/examples" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                Examples
              </Link>
              <Link href="/community" className="block px-4 py-2 text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                Community
              </Link>
            </div>
            ...
            <div className="pt-4 border-t border-white/10">
              <Link
                href="/login"
                className="block w-full px-4 py-2 mb-2 text-center text-gray-300 hover:text-white border border-white/10 rounded-lg transition-colors"
              >
                Sign In
              </Link>
              <Link
                href="/signup"
                className="block w-full px-4 py-2 text-center bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg font-semibold transition-all"
              >
                Get Started Free
              </Link>
            </div>
